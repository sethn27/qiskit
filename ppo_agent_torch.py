...
class ActorNetwork(nn.Module):
        def __init__(self,n_actions, input_dims,alpha, fc1_dims=256, fc2_dims=256, chkpt_dir='quantumtest/'):
...
class CriticNetwork(nn.Module):
        def __init__(self, input_dims, alpha, fc1_dims=256, fc2_dims=256, chkpt_dir='quantumtest/'):
...
class Agent:
        ...
        def learn(self):
                for _ in range(self.n_epochs):
                        state_arr, action_arr, old_probs_arr, vals_arr, reward_arr, done_arr, batches = self.memory.generate_batch()
