...
class ActorNetwork(nn.Module):
    def __init__(self, 
        ...
        self.action_value_max = 0.4
        self.action_value_min = -0.4
    ...
    def forward(self,
        ...
        if action > 0:
            action = action + self.action_value_max

        else:
            action = action +self.action_value_min
    ...
    def sample_action(self,
        ...
        action = torch.clip(action, self.action_value_min, self.action_value_max)
...
class SAC_Agent:
    ...
    def training(self):
        ...
        return actor_loss.mean().detach().item()
